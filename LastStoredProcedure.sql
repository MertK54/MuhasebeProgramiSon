...
BEGIN
    ...
    FROM 
        stocks
    JOIN 
        suppliers ON stocks.supplier_id = suppliers.supplier_id;
END //
DELIMITER ;
...
BEGIN
    ...
    INSERT INTO invoices (invoice_id,invoice_number, supplier_id, customer_id, product_name, quantity, unit_price,total_amount,type) 
    VALUES (UUID(),$new_invoice_number, $supplier_id, $customer_id, $product_name, $quantity, $unit_price,$total_amount,$type);
END //
DELIMITER ;
